...
async def help(ctx):
    ...
    if ctx.message.author.bot:
        ...
        embed.set_image(url = 'https://image.ibb.co/caM2BK/help.gif')
        embed.add_field(name = 'Checkout our bots website',value ='its on beta still so all commands information are not shown!',inline = False)
...
async def ownerinfo(ctx):
    ...
    embed.add_field(name="bot official website", value="Note: the website is still in beta so all commands information are not shown!")
    embed.set_image(url="https://cdn.discordapp.com/attachments/546667977181757450/550645098451304458/453b79abdd41725ec9f8dbf22635118a--assassin-game--story.png")
