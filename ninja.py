...
async def status_task():
    while True:
        ...
        await asyncio.sleep(4)
        await client.change_presence(game=discord.Game(name='Join support server for advertising your hardworked programmed bot! by using n!server!',status=discord.Status("idle"), afk=False))
        await asyncio.sleep(4)
...
async def ownerinfo(ctx):
    embed = discord.Embed(title="Information about owner", description="Main Creator: 𝓫𝓵𝓾𝒆𝓫𝓲𝓻𝓭", color=0x00ff00)
    embed.set_author(name=" Bot Owner: 𝓫𝓵𝓾𝒆𝓫𝓲𝓻𝓭#0440")
    embed.add_field(name="Owner: 𝓫𝓵𝓾𝒆𝓫𝓲𝓻𝓭#0440", value="He coded the bot")
